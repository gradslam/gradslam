...
def relative_transformation(
        trans_01: torch.Tensor, trans_02: torch.Tensor, orthogonal_rotations: bool = False) -> torch.Tensor:
    ...
    trans_10: torch.Tensor = inverse_transformation(trans_01) if orthogonal_rotations else torch.inverse(trans_01)
